...
extern float screen_zoom, screen_center_x, screen_center_y, zoom_factor;
extern int score,baloon_press,life;
...
extern const color_t COLOR_GREENO;
extern const color_t COLOR_BLUE;
extern const color_t COLOR_BROWN;
extern const color_t COLOR_BALOON;
extern const color_t COLOR_SEMRING;
